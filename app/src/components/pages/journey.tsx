    ...
    <PageWrapper page="journey">
      <div className="mb-8">
        ...
        <h1 className="text-[1.9rem] font-bold leading-[1.12] mb-2">
          One 40-day line, told honestly.
        </h1>
        <p className="text-[15px] leading-[1.7]" style={{ color: "var(--text-secondary)" }}>
          Declaration, signal, reflection, and ceremony now live inside one narrative. The Boss does not forget
      ...
      >
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
          <div>
            <div className="text-[1.25rem] font-semibold mb-1">
              {day > 0 ? `Day ${day} of 40` : "Sprint not live yet"}
            </div>
        ...
        <div className="w-full h-[6px] mb-5" style={{ background: "var(--bg-page)", borderRadius: "999px" }}>
          <div
            className="h-full"
            style={{ width: `${progress}%`, background: "var(--accent)", borderRadius: "999px" }}
          />
        </div>

        <p className="text-[14px] leading-[1.65] mb-5" style={{ color: "var(--text-secondary)" }}>
          {phase.body}
        </p>
        ...
        <div className="grid grid-cols-1 gap-3">
          {milestones.map((milestone) => (
            ...
            >
              <div
                className="w-12 shrink-0 text-[11px] uppercase tracking-[0.08em] pt-0.5"
                style={{ ...mono, color: milestone.status === "current" ? "var(--accent)" : "var(--text-muted)" }}
              >
                Day {milestone.day}
              </div>
