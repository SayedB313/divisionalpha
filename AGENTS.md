...
- **100% of the quarterly fund** goes to the winning team
- **Cohort return:** Winning team proposes a self-set % of venture profits back to cohort — forever
- **Board member:** Winning team accepts a board member from cohort/DA as condition of fund
- **Fund released in milestones/tranches** — DA is a partner, not a prize-giver
- **Obligation follows the team**, not the idea. If venture pivots, obligation travels.
- **Past winners:** Full re-entry allowed. Multiple rule options being explored.
- Selection via **judges, pitches, metrics, votes** (metrics 30-40%, panel 25-35%, peer 25%, Boss Score ~20%)
- **Cohort size:** 4-8 teams (dynamic, min 3)
- **Round frequency:** Quarterly (~3 sprints)
- **Min fund threshold:** $5,000/round
